...
describe("Windows installer smoke workflow", () => {
  ...
  it("uploads the machine-readable report even when the native check fails", () => {
    const diagnostics = steps.find(({ body }) => body.includes("name: windows-x64-installer-verification"));
    ...
    const report = "multica-windows-x64-installer-smoke.json";
