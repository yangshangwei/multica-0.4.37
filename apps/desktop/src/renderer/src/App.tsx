...
export default function App() {
  ...
  // Machine identity for intranet deployments that mint a session from a
  // device id. Read once at preload time; CoreProvider only reaches for it on a
  // boot with no stored token, and only when the server declares device auth.
  const deviceIdentity = window.desktopAPI.deviceIdentity;
