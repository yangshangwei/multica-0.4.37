      ...
      entries: [
        {
          version: "0.4.40",
          date: "2026-09-05",
          title: "런타임, MCP, 세션을 선택적으로 개선",
          changes: [],
          features: [
            "에이전트 모델 선택기에서 런타임 모델 목록을 바로 새로 고칠 수 있습니다.",
            "설치된 Claude Code 모델을 검색하고 사용할 수 없는 모델도 표시합니다.",
            "MCP 서버 연결을 설정하거나 교체해도 할당된 에이전트를 잃지 않습니다.",
            "해당 가격 정보와 함께 Claude Fable 5.1을 사용할 수 있습니다.",
          ],
          improvements: [
            "비공개 런타임을 볼 수 없는 경우에도 공유 에이전트의 상태를 안전하게 확인할 수 있습니다.",
            "세션이 만료되면 로그인 화면으로 돌아가고 오래된 클라이언트 상태를 정리합니다.",
          ],
          fixes: [
            "예약된 자동화 작업이 트리거를 만든 사람의 권한을 유지합니다.",
            "작업을 넘길 때 워크트리와 캐시된 체크아웃을 더 안정적으로 처리합니다.",
          ],
        },
        {
          version: "0.4.37",
