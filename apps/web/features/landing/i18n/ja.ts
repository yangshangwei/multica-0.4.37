      ...
      entries: [
        {
          version: "0.4.40",
          date: "2026-09-05",
          title: "ランタイム、MCP、セッションの選択的な改善",
          changes: [],
          features: [
            "エージェントのモデル選択画面から、ランタイムのモデル一覧を直接更新できます。",
            "インストール済みの Claude Code モデルを検出し、利用できないモデルも表示します。",
            "MCP サーバーの接続を設定・差し替えしても、割り当て済みのエージェントを失いません。",
            "対応する料金情報とともに Claude Fable 5.1 を利用できます。",
          ],
          improvements: [
            "非公開ランタイムを表示できない場合も、共有エージェントの状態を安全に確認できます。",
            "セッションの有効期限が切れるとログイン画面に戻り、古いクライアント状態を消去します。",
          ],
          fixes: [
            "スケジュール実行は、トリガーを作成したメンバーの権限を維持します。",
            "タスクの引き継ぎ時も、ワークツリーとキャッシュ済みチェックアウトを安定して扱います。",
          ],
        },
        {
          version: "0.4.37",
