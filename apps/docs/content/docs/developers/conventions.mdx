...
- **`skill`** keeps lowercase English in Chinese text — a Multica-specific concept with no established Chinese term; titles may capitalize as `Skills`. The one exception is the sidebar nav destination label, rendered as 「技能库」.
