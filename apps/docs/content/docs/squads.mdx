...
The **Squads** page offers **Use a template**, which staffs a whole squad in one step. Two are built in:
...
- **Roles you already have are reused, exactly as they stand.** If you staffed the Feature Delivery squad and then staff the Bug Fix squad, both use the same Implementer — including any instructions you edited. Staffing a second squad never overwrites an agent.
