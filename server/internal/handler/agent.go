...
type AgentTaskResponse struct {
	...
	NewCommentsDeltaKnown    bool                   `json:"new_comments_delta_known,omitempty"`    // server successfully computed the issue-wide comment delta; absent/false is ambiguous and must not waive the scan
