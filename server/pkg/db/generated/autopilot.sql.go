...
INSERT INTO autopilot (
    ...
    $5, $6, $12, $13,
    $7, $8, $9, $10
) RETURNING id, workspace_id, title, description, assignee_id, status, execution_mode, issue_title_template, created_by_type, created_by_id, last_run_at, created_at, updated_at, assignee_type, project_id, pause_reason, template_key, template_version
`
...
SELECT id, workspace_id, title, description, assignee_id, status, execution_mode, issue_title_template, created_by_type, created_by_id, last_run_at, created_at, updated_at, assignee_type, project_id, pause_reason, template_key, template_version FROM autopilot
WHERE id = $1
`
...
SELECT
  a.id, a.workspace_id, a.title, a.description, a.assignee_id, a.status, a.execution_mode, a.issue_title_template, a.created_by_type, a.created_by_id, a.last_run_at, a.created_at, a.updated_at, a.assignee_type, a.project_id, a.pause_reason, a.template_key, a.template_version,
  (
...
func (q *Queries) ListAutopilots(ctx context.Context, arg ListAutopilotsParams) ([]ListAutopilotsRow, error) {
	...
	for rows.Next() {
		...
		if err := rows.Scan(
			...
			&i.Autopilot.TemplateKey,
			&i.Autopilot.TemplateVersion,
			&i.TriggerKinds,
			&i.NextRunAt,
			&i.LastRunStatus,
		); err != nil {
...
RETURNING a.id, a.workspace_id, a.title, a.description, a.assignee_id, a.status, a.execution_mode, a.issue_title_template, a.created_by_type, a.created_by_id, a.last_run_at, a.created_at, a.updated_at, a.assignee_type, a.project_id, a.pause_reason, a.template_key, a.template_version
`
